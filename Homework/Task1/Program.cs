...
void Execute() // Основное тело программы
{
    ...
    System.Console.WriteLine("This program receives as input the sizes of a two-dimensional array M and N and fills it with random real numbers.");
    var dimensionsOfArray = PromptDimensionsOfArray("Enter the number of rows M and columns N separated by a space. For example:5 2 -> ");
